...
from widgetsnow import __login__
...
__login__obj = __login__(auth_token = "courier_auth_token12345", 
                    company_name = "mojojojo",
...
if LOGGED_IN == True:
    ...
    if st.session_state.tab_selection == "Logout":
